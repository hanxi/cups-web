...
func main() {
	...
	protected.HandleFunc("/scanner-info", printerInfoHandler).Methods("GET")
	protected.HandleFunc("/scanners", listScannersHandler).Methods("GET")
	protected.HandleFunc("/scan", scanHandler).Methods("POST")
	protected.HandleFunc("/scan/{id:[0-9]+}/status", scanStatusHandler).Methods("GET")
	protected.HandleFunc("/scan/{id:[0-9]+}/file", scanFileHandler).Methods("GET")
	protected.HandleFunc("/scan-records", scanRecordsHandler).Methods("GET")
	protected.HandleFunc("/paper-sizes", listPaperSizesHandler).Methods("GET")
	protected.HandleFunc("/paper-sizes", createPaperSizeHandler).Methods("POST")
	protected.HandleFunc("/paper-sizes/{id:[0-9]+}", updatePaperSizeHandler).Methods("PUT")
	protected.HandleFunc("/paper-sizes/{id:[0-9]+}", deletePaperSizeHandler).Methods("DELETE")
